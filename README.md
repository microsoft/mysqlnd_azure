...
The extension is named with **mysqlnd_azure**, currently the valid source code branch is:
*mysqlnd-azure-php-cc-7-2 : Compatiable with PHP7.2 latest version and PHP7.3 latest version
